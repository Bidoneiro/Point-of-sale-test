...
Price:
and also by changing the variable sizeOfList in the class ProductDatabase.
To exit the program you need to write "exit" instead of barcode.


To run this program using file "Point of sale 1.0" you will need to edit it as a text file 
and change the route to java sdk. // in line  java path
